            ...
            try:
                ...
                if QApplication.instance():
                    for widget in QApplication.instance().allWidgets():
                        if hasattr(widget, 'start_detection') and hasattr(widget, '__class__') and widget.__class__.__name__ == 'MainWindow':
                            main_window = widget
                            break
            except ImportError:
                pass
    ...
    def _stop_detection(self):
        ...
        try:
            ...
            try:
                ...
                if QApplication.instance():
                    for widget in QApplication.instance().allWidgets():
                        if hasattr(widget, 'stop_detection') and hasattr(widget, '__class__') and widget.__class__.__name__ == 'MainWindow':
                            main_window = widget
                            break
            except ImportError:
                pass
